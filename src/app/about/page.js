  ...
  return (
    <PageContainer>
      <div>
        ...
        <section className="lg:grid gap-16 grid-cols-2 mb-16">
          <div>
            ...
            <p>
              ...
              building tools for web3 users. During a very rough time for
              crypto, we pivoted from a debit card product to finally launching
              a{" "}
              <a
            ...
            <p>
              ...
              <a
                ...
                rel="noopener noreferrer"
              ></a>
              acquired by PayPal) where we built a contextual commerce platform
              to help small and medium businesses launch quickly on native iOS
              and Android apps.
            </p>
            <p>
